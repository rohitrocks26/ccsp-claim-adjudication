package com.ccsp.event.store.spring;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.ccsp.store.repo", entityManagerFactoryRef = "eventStoreEntityManager", transactionManagerRef = "eventStoreTransactionManager")
public class EventStorePersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean eventStoreEntityManager() {
        ...
        em.setPackagesToScan(new String[] { "com.ccsp.commons.persistence.event" });
