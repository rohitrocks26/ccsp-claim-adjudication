package com.ccsp.accums.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.ccsp.accums.repo", entityManagerFactoryRef = "scoringEntityManager", transactionManagerRef = "scoringTransactionManager")
public class AccumsPersistenceConfig {

    @Autowired
    private Environment env;

    public AccumsPersistenceConfig() {
        super();
    }
    ...
    public LocalContainerEntityManagerFactoryBean scoringEntityManager() {
        ...
        em.setPackagesToScan(new String[] { "com.ccsp.accums.model" });
