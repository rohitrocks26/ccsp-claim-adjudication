...
@SpringBootTest(classes = { ScoringProjectionApp.class, ScoringProjectionPersistenceConfig.class, EventStorePersistenceConfig.class, EventsConfig.class })
public class SudoCommunicationProjectionIntegrationTest {
